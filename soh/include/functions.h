...
uint16_t Interface_DrawTextLineOnBuffer(GraphicsContext* gfx, char text[], int16_t x, int16_t y, uint16_t colorR, uint16_t colorG, uint16_t colorB, uint16_t colorA, float textScale, uint8_t textShadow);
void Interface_DrawTextCharacterOnExistingBuffer(GraphicsContext* gfx, int16_t x, int16_t y, void* texture, uint16_t colorR, uint16_t colorG, uint16_t colorB, uint16_t colorA, float textScale, uint8_t textShadow);
